    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md z-10">
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl p-8 ring-1 ring-purple-500/20">
          ...
          {error && (
            <div
              className="mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-xl flex items-start space-x-3 animate-shake"
              role="alert"
            >
          ...
          >
            <div>
              <label
                htmlFor="username"
                className="text-sm font-medium text-slate-100 block mb-1.5"
                aria-required="true"
              >
                Username
              </label>
            ...
            {demoUsers.map((user, index) => (
              ...
              >
                <div className="flex items-center space-x-3">
                  <div
                    className={`w-4 h-4 ${user.color} rounded-full group-hover:scale-110 transition-transform`}
                  ></div>

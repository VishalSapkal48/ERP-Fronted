...
const PurchasesLayout = ({ onLogout }) => {
  ...
  const handleLogout = () => {
    try {
      console.log("PurchasesLayout: Initiating logout");
      ...
      if (onLogout) {
        console.log("PurchasesLayout: Calling onLogout from App.js");
        onLogout();
      }

      // Navigate to login page
      console.log("PurchasesLayout: Navigating to /");
      navigate("/", { replace: true });

      // Close sidebar on mobile
      if (isSidebarOpen) {
        console.log("PurchasesLayout: Closing sidebar");
        toggleSidebar();
      }
    } catch (error) {

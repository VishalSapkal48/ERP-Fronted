...
const mockInvoices = [
  {
    ...
    shippingAddress: '456 Delivery Ave, Pune, MH 411001',
    date: '2025-07-26',
    dueDate: '2025-08-25',
    status: 'pending',
    total: 15750.00,
  ...
  },
  {
    ...
    billingAddress: '789 Commerce Rd, Delhi, DL 110001',
    shippingAddress: '321 Distribution Hub, Gurgaon, HR 122001',
    date: '2025-07-25',
    dueDate: '2025-08-24',
    status: 'paid',
    total: 8850.00,
...
function InvoiceList() {
  ...
  if (viewMode === 'create' || viewMode === 'edit') {
    return <InvoiceForm onSave={handleSave} onCancel={handleCancel} initialData={selectedInvoice} />;
  }
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-lg font-semibold">{selectedInvoice.customerAddress}</p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Billing Address</p>
              <p className="text-lg font-semibold">{selectedInvoice.billingAddress}</p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Shipping Address</p>
              <p className="text-lg font-semibold">{selectedInvoice.shippingAddress}</p>
            </div>
            <div>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <p className="text-lg font-semibold">₹{selectedInvoice.subtotal.toLocaleString()}</p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Tax</p>
              <p className="text-lg font-semibold">₹{selectedInvoice.tax.toLocaleString()}</p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Total</p>
              <p className="text-lg font-semibold">₹{selectedInvoice.total.toLocaleString()}</p>
            </div>
          </div>
          <div className="mt-6">
            <button

...
const { formConfig, validationMessages } = OnlineSurveyQuestion;

// --- Helper Components (Radio, Input, ImageUpload, Checkbox) ---
...
const OnlineSurveyForm = () => {
  ...
  // --- No API, just local toast and reset ---
  const handleSubmit = async () => {
    ...
    setTimeout(() => {
      toast.success(
        lang === "mr"
          ? "फॉर्म यशस्वीरीत्या सबमिट केला! (फक्त फ्रंटएंड)"
          : "Form submitted successfully! (Frontend only)",
...
export default OnlineSurveyForm;

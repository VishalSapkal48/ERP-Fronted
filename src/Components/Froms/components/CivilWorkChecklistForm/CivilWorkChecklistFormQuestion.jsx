...
const questions = [
  ...
  {
    key: "internet_understood",
    question_mr: "तुम्हाला वरील कामाची माहिती समजली का?",
    question_en: "Do you understand the above work information?",
  },
  {
    key: "speaker_understood",
    question_mr: "तुम्हाला वरील कामाची माहिती समजली का?",
    question_en: "Do you understand the above work information?",
  },
  {
    key: "painting_understood",
    question_mr: "तुम्हाला वरील कामाची माहिती समजली का?",
    question_en: "Do you understand the above work information?",
  },
  {
    key: "plumber_understood",
    question_mr: "तुम्हाला वरील कामाची माहिती समजली का?",
    question_en: "Do you understand the above work information?",
  },
  {
    key: "electrician_switch_socket_understood",
    question_mr: "तुम्हाला वरील कामाची माहिती समजली का?",
    question_en: "Do you understand the above work information?",
  },
  {
    key: "electrician_material_understood",
    question_mr: "तुम्हाला वरील कामाची माहिती समजली का?",
    question_en: "Do you understand the above work information?",
  },
  {
    key: "electrician_wire_understood",
    question_mr: "तुम्हाला वरील कामाची माहिती समजली का?",
    question_en: "Do you understand the above work information?",
  },
  {
    key: "pop_tiles_understood",
    question_mr: "तुम्हाला वरील कामाची माहिती समजली का?",
    question_en: "Do you understand the above work information?",
  },
  {
    key: "gas_piping_understood",
    question_mr: "तुम्हाला वरील कामाची माहिती समजली का?",
    question_en: "Do you understand the above work information?",
  },
];
...
const tableData2 = [
  {
    item: "Internet",
    company: "Any Local Brand",
    specification: "Above 40 Mbps",
    qty: "1 Year",
  },
];
...
const tableData3 = [
  {
    ...
    company: "Any Local Brand",
    specification: "Base-1, Speaker-4",
    qty: "1",
  },
];
...
const tableData4 = [
  {
    item: "Shutter",
    company: "Asian",
    specification: "Grey-0616 (Oil Paint)",
    qty: "As Per Shop",
  },
  {
    item: "Ceiling",
  ...
  },
  {
    item: "Shutter Logo",
    company: "Asian",
    specification: "36 inch x 36 inch Round (As Per Board Name Logo)",
    qty: "1",
  },
];
...
const tableData5 = [
  {
    item: "Water Tank",
    company: "Any Brand",
    specification: "1000 Litre",
    qty: "2",
    work: "As Per Shop Layout",
  },
  {
    item: "Sink Inlet",
    company: "Paras, Prince, Plasto, or Any Brand",
    specification: "0.5 inch UPVC Pipe",
    qty: "-",
    work: "As Per Shop, 43 inch Height From Floor",
  },
  {
    item: "Sink Outlet",
    company: "Paras, Prince, Plasto, or Any Brand",
    specification: "2.5 inch PVC Pipe",
    qty: "-",
    work: "As Per Underground Drainage Line",
  },
  {
    item: "Water Tap (Sink)",
    company: "Paras, Prince, Plasto, or Any Brand",
  ...
  },
  {
    item: "Steamer Inlet",
    company: "Paras, Prince, Plasto, or Any Brand",
    specification: "0.5 inch CPVC Pipe (Attach NRV Valve)",
    qty: "-",
    work: "As Per Shop, 18 inch Height From Floor",
  },
  {
    item: "Steamer Outlet",
    company: "Paras, Prince, Plasto, or Any Brand",
    specification: "2.5 inch CPVC Pipe",
    qty: "-",
    work: "As Per Underground Drainage Line",
  },
  {
...
const tableData9 = [
  {
    item: "POP Tiles",
    company: "Any Reputed Brand",
    specification: "2x2 ft, White",
    qty: "As Per Shop",
    work: "As Per Shop Layout",
  },
  {
...
const tableData10 = [
  {
    item: "Gas Piping",
    company: "Any Reputed Brand",
    specification: "0.5 inch Copper Pipe",
    qty: "As Per Shop",
    work: "As Per Kitchen Layout",
  },
  {
    item: "Regulator",
    company: "Any Reputed Brand",

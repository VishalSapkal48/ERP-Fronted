...
import logo from "../../../../../public/Images/BoardWorksListForm/logo.png"; // Adjust the path if needed, based on your project structure
import img1 from "../../../../../public/Images/CameraSetup/Picture1.png"; // Placeholder image, adjust path as needed
...
const CameraSetForm = () => {
  ...
  const cameraSetItems = [
    {
      no: 1,
      name: "CCTV Camera",
      description:
        "Brand: CP Plus, Module: Dome Camera -3, Color: White, Specification: 2/3/4 MP full HD Dome camera, Range: 30 Mtr, Resolution: 1080p, Technology: iPhone, iPad, Android phone, Audio technology available, Mobile software: iCMOB, gCMOB",
      qty: 1,
      photos: [img1],
    },
    {
      ...
      description: "Place: Out of shutter L/R side, Highlight: Dine-in area",
      qty: 1,
      photos: [img2],
    },
    {
      ...
      name: "Camera No.2",
      description:
        "Place: Left side wall (corner), Highlight: Customer service area, menu frame, and TV",
      qty: 1,
      photos: [img3],
    },
    {
      ...
      name: "Camera No.3",
      description:
        "Place: Left side wall, Highlight: Billing, employee service area",
      qty: 1,
      photos: [img4],
    },
    {
      ...
      name: "Camera No.4",
      description:
        "Place: Left side/right wall, Highlight: Operation at burner and milk machine",
      qty: 1,
      photos: [img5],
    },
    {
      ...
      description:
        "Digital Storage Capacity: 1 TB, Hard Disk Interface: eSATA, Connectivity Technology: eSATA, Brand: D25, Special Feature: Portable, Shock Resistant, Hard Disk Form Factor: 3.5 Inches, Hard Disk Description: Mechanical Hard Disk, Compatible Devices: Desktop, Camera, Installation Type: Internal Hard Drive, Colour: Silver",
      qty: 1,
      photos: [img6],
    },
    {
      ...
      name: "3U Rack",
      description:
        "Brand: Crotomak, Colour: Grey, Product Dimensions: 40D x 40.5W x 15.5H Centimeters, Size: 3U Rack, Material: Iron & Cast Iron",
      qty: 1,
      photos: [img7],
    },
    {
      ...
      description:
        "Brand: CP PLUS, Connectivity Technology: Wired, Video Capture Resolution: 1080N, Special Feature: Night Vision, App Control, Number of Channels: 1",
      qty: 1,
      photos: [img8],
    },
  ];
  ...
  const translations = {
    en: {
      title: "YNK",
      formTitle: "CP PLUS Camera Set Form",
      switchLang: "मराठी",
      ...
      sections: [
        {
          title: "Camera Set Items",
          table: cameraSetItems.map((item) => ({
            no: item.no,
            name: item.name,
    ...
    mr: {
      title: "वायएनके",
      formTitle: "सीपी प्लस कॅमेरा सेट फॉर्म",
      switchLang: "English",

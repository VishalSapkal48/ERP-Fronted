...
export default function MaterialChecklist() {
  ...
  // Date/time (simple, since no custom hook)
  const formatDateTime = (lang) => {
    const now = new Date();
    if (lang === "mr") {
      return `दिनांक: ${now.toLocaleDateString("en-GB")}`;
    }
    return `Date: ${now.toLocaleDateString("en-GB")}`;
  };
        ...
        <div className="px-2 sm:px-6 py-4 sm:py-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between mb-4 sm:mb-6 gap-4">
            <button
              ...
              className={`text-sm sm:text-base px-2 sm:px-6 py-1 sm:py-2 text-gray-600 underline hover:text-blue-600 ${
            ...
            <button
              ...
              className={`text-sm sm:text-base px-4 sm:px-6 py-1.5 sm:py-2 rounded text-white ${
            ...
            <>
              ...
              <div className="flex justify-center px-2 sm:px-4">
                <button
                  ...
                  className={`text-sm sm:text-base bg-green-600 text-white px-4 sm:px-6 py-1.5 sm:py-2 rounded hover:bg-green-700 transition-colors`}
                >

  ...
  fields: [
    {
      ...
      question_en:
        "Did the developer team send the quotation to the sales department?",
      type: "yesOther",
    },
    {
      id: "sales_to_owner_quotation",
      question_mr: "सेल्स डिपार्टमेंटने ओनरला कोटेशन पाठवले का?",
    ...
    },
    {
      ...
      question_mr: "ओनरने पूर्ण कोटेशन चेक केले का?",
      question_en: "Did the owner check the complete quotation?",
      type: "yesno",
    },
    {
      id: "quotation_finalized",
      question_mr: "ओनरसोबत सेल्स डिपार्टमेंटचे कोटेशन फायनल झाले का?",
      question_en:
        "Has the quotation from the sales department been finalized with the owner?",
      type: "yesno",
    },
    {
    ...
    },
    {
      ...
      question_mr:
        "लेआउट फायनल झाल्यानंतर त्या साईटसाठी इंजिनिअर असाइन केला का?",
      question_en:
        "Was an engineer assigned to the site after layout finalization?",
      type: "yesno",
    },
    {
...
const InternalDepartmentWorkingQuestion = {
  formConfig,
  validationMessages,
};

export default InternalDepartmentWorkingQuestion;
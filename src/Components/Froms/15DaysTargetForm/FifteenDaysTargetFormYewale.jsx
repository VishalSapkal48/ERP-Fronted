...
const tasks = [
  ...
  },
  {
    ...
    description_mr: [
      ...
      "एमएस फ्रेम, एसीपी, अॅक्रिलिक, एलईडी इत्यादी आवश्यक साहित्य खरेदी करणे.",
      ...
      "विनाइल, अॅक्रिलिक किंवा बॅकलिट सामग्री वापरून अंतिम ब्रँडिंग निश्चित करणे.",
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gray-100">
      <div className="w-full max-w-4xl bg-[#e3f2fd] p-6 rounded-xl shadow-md">
        ...
        <h2 className="text-lg text-center font-bold mb-4">
          {language === "mr" ? "15 दिवसांचे लक्ष्य फॉर्म - येवले" : "15 Days Target Form - Yewale"}
        </h2>
